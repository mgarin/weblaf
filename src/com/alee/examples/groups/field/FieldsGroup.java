...
public class FieldsGroup extends DefaultExampleGroup
{
    ...
    public List<Example> getGroupExamples ()
    {
        ...
        examples.add ( new TextFieldsExample () );
        examples.add ( new PasswordFieldsExample () );
        examples.add ( new FieldsInputPromptExample () );
        examples.add ( new FormattedTextFieldsExample () );
        examples.add ( new FieldComponentsExample () );
        examples.add ( new SpinnersExample () );
        return examples;
    }
}