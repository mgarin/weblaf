...
public final class LafUtils
{
    ...
    {
        return new BorderUIResource.EmptyBorderUIResource ( insets.top, insets.left, insets.bottom, insets.right );
    }

    public static Border createWebBorder ( final int top, final int left, final int bottom, final int right )
    {
        return new BorderUIResource.EmptyBorderUIResource ( top, left, bottom, right );
    }

    public static Border createWebBorder ( final int margin )
    {
        return new BorderUIResource.EmptyBorderUIResource ( margin, margin, margin, margin );
    }
