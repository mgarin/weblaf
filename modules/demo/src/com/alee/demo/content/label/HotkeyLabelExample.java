...
public class HotkeyLabelExample extends AbstractExample
{
    @Override
    public String getId ()
    {
    ...
    protected class TextHotkeyLabel extends AbstractStylePreview
    {
        ...
        {
            super ( HotkeyLabelExample.this, "text", featureState, styleId );
        }
    ...
    protected class CodeHotkeyLabel extends AbstractStylePreview
    {
        ...
        {
            super ( HotkeyLabelExample.this, "code", featureState, styleId );
        }
    ...
    protected class DataHotkeyLabel extends AbstractStylePreview
    {
        ...
        {
            super ( HotkeyLabelExample.this, "data", featureState, styleId );
        }
