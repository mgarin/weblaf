...
public class DynamicMenuGroup extends DefaultExampleGroup
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return loadGroupIcon ( "dynmenu.png" );
    }
    ...
    {
        return "Dynamic menu usage example";
    }
    ...
    {
        return CollectionUtils.copy ( ( Example ) new DynamicMenuExample () );
    }
}