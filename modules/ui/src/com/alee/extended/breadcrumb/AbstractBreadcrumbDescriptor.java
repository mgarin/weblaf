 ...
 */
public abstract class AbstractBreadcrumbDescriptor<C extends WebBreadcrumb, U extends WBreadcrumbUI>
        extends AbstractComponentDescriptor<C, U>
{
     ...
     */
    public AbstractBreadcrumbDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
