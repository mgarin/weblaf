...
/**
 * Custom background implementation for {@link com.alee.extended.label.WebHotkeyLabel}.
 *
 * @param <E> component type
 * @param <D> decoration type
 * @param <I> background type
 * @author Mikle Garin
 * @see com.alee.extended.label.WebHotkeyLabel
 */

@XStreamAlias ( "HotkeyLabelBackground" )
public class WebHotkeyLabelBackground<E extends WebHotkeyLabel, D extends IDecoration<E, D>, I extends WebHotkeyLabelBackground<E, D, I>>
        extends AbstractBackground<E, D, I>
{
    /**
     * todo 1. Replace with comon classes later when multiply borders are supported
     */
