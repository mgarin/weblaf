 ...
 */
public abstract class AbstractOverlayDescriptor<C extends WebOverlay, U extends WOverlayUI> extends AbstractComponentDescriptor<C, U>
{
    /**
     ...
     */
    public AbstractOverlayDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
