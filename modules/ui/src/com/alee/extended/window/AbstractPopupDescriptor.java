 ...
 */
public abstract class AbstractPopupDescriptor<C extends WebPopup, U extends WPopupUI> extends AbstractComponentDescriptor<C, U>
{
    /**
     ...
     */
    public AbstractPopupDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
