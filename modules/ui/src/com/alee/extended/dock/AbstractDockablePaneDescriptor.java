 ...
 */
public abstract class AbstractDockablePaneDescriptor<C extends WebDockablePane, U extends WDockablePaneUI>
        extends AbstractComponentDescriptor<C, U>
{
     ...
     */
    public AbstractDockablePaneDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
