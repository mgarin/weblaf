 ...
 * @author Mikle Garin
 */
public abstract class WebComponent<C extends WebComponent<C, U>, U extends ComponentUI> extends JComponent implements Styleable,
        EventMethods, ToolTipMethods, LanguageMethods, LanguageEventMethods, SettingsMethods, FontMethods<C>, SizeMethods<C>
{
    ...
    @NotNull
    @Override
    public C setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public C setMinimumSize ( final int width, final int height )
    {
