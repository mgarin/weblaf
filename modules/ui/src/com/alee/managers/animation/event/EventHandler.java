...
/**
 * Base interface for any custom events handler.
 *
 * @author Mikle Garin
...
{
    /**
     * Asks handler to perform event {@link Runnable}.
     *
     * @param event event {@link Runnable} to perform
     */
    public void handle ( Runnable event );
}