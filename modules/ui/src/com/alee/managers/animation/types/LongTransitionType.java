...
{
    @Override
    public Long value ( final Easing easing, final Long start, final Long goal, final double progress, final double total )
    {
        return adjust ( easing, start, goal, progress, total );
    }

    /**
     * Returns adjusted {@link Long} value.
     ...
     * @return adjusted {@link Long} value
     */
    public static long adjust ( final Easing easing, final Long start, final Long goal, final double progress, final double total )
    {
        return Math.round ( easing.calculate ( start, goal - start, progress, total ) );
    }
}