...
/**
 * {@link Float} values transition support.
 *
 * @author Mikle Garin
...
{
    @Override
    public Float value ( final Easing easing, final Float start, final Float goal, final double progress, final double total )
    {
        return adjust ( easing, start, goal, progress, total );
    }

    /**
     * Returns adjusted {@link Float} value.
     ...
     * @return adjusted {@link Float} value
     */
    public static float adjust ( final Easing easing, final Float start, final Float goal, final double progress, final double total )
    {
        return ( float ) easing.calculate ( start, goal - start, progress, total );
    }
}