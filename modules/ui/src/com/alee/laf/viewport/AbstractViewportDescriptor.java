 ...
 */
public abstract class AbstractViewportDescriptor<C extends JViewport, U extends WViewportUI> extends AbstractComponentDescriptor<C, U>
{
    /**
     ...
     */
    public AbstractViewportDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
