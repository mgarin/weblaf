 ...
 * @see RootPanePainter
 */
public class WebRootPane extends JRootPane implements Styleable, EventMethods, LanguageEventMethods, SettingsMethods,
        FontMethods<WebRootPane>, SizeMethods<WebRootPane>
{
    /**
    ...
    @NotNull
    @Override
    public WebRootPane setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebRootPane setMinimumSize ( final int width, final int height )
    {
