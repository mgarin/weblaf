 ...
 * @see SliderPainter
 */
public class WebSlider extends JSlider implements Styleable, EventMethods, ToolTipMethods, LanguageMethods, LanguageEventMethods,
        SettingsMethods, FontMethods<WebSlider>, SizeMethods<WebSlider>
{
    ...
    @NotNull
    @Override
    public WebSlider setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebSlider setMinimumSize ( final int width, final int height )
    {
