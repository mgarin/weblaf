 ...
 */
public abstract class AbstractCheckBoxMenuItemDescriptor<C extends JCheckBoxMenuItem, U extends WebCheckBoxMenuItemUI>
        extends AbstractComponentDescriptor<C, U>
{
     ...
     */
    public AbstractCheckBoxMenuItemDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
