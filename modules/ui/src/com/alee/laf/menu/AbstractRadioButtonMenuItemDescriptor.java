 ...
 */
public abstract class AbstractRadioButtonMenuItemDescriptor<C extends JRadioButtonMenuItem, U extends WebRadioButtonMenuItemUI>
        extends AbstractComponentDescriptor<C, U>
{
     ...
     */
    public AbstractRadioButtonMenuItemDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
