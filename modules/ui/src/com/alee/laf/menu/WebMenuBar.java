 ...
 * @see MenuBarPainter
 */
public class WebMenuBar extends JMenuBar implements Styleable, Paintable, ShapeMethods, MarginMethods, PaddingMethods,
        ContainerMethods<WebMenuBar>, EventMethods, ToolTipMethods, LanguageMethods, LanguageEventMethods, SettingsMethods,
        FontMethods<WebMenuBar>, SizeMethods<WebMenuBar>
{
    /**
    ...
    @Override
    public WebMenuBar add ( final java.util.List<? extends Component> components )
    {
        return ContainerMethodsImpl.add ( this, components );
    }

    @Override
    public WebMenuBar add ( final java.util.List<? extends Component> components, final int index )
    {
        return ContainerMethodsImpl.add ( this, components, index );
    }

    @Override
    public WebMenuBar add ( final java.util.List<? extends Component> components, final Object constraints )
    {
        return ContainerMethodsImpl.add ( this, components, constraints );
    }

    @Override
    public WebMenuBar add ( final Component component1, final Component component2 )
    {
        return ContainerMethodsImpl.add ( this, component1, component2 );
    }

    @Override
    public WebMenuBar add ( final Component... components )
    {
        return ContainerMethodsImpl.add ( this, components );
    }

    @Override
    public WebMenuBar remove ( final java.util.List<? extends Component> components )
    {
        return ContainerMethodsImpl.remove ( this, components );
    }

    @Override
    public WebMenuBar remove ( final Component... components )
    {
        return ContainerMethodsImpl.remove ( this, components );
    }

    @Override
    public WebMenuBar removeAll ( final Class<? extends Component> componentClass )
    {
    ...
    @Override
    public WebMenuBar equalizeComponentsWidth ()
    {
        return ContainerMethodsImpl.equalizeComponentsWidth ( this );
    }

    @Override
    public WebMenuBar equalizeComponentsHeight ()
    {
    ...
    @Override
    public WebMenuBar setPlainFont ()
    {
        return FontMethodsImpl.setPlainFont ( this );
    }

    @Override
    public WebMenuBar setPlainFont ( final boolean apply )
    {
    ...
    @Override
    public WebMenuBar setBoldFont ()
    {
        return FontMethodsImpl.setBoldFont ( this );
    }

    @Override
    public WebMenuBar setBoldFont ( final boolean apply )
    {
    ...
    @Override
    public WebMenuBar setItalicFont ()
    {
        return FontMethodsImpl.setItalicFont ( this );
    }

    @Override
    public WebMenuBar setItalicFont ( final boolean apply )
    {
    ...
    @Override
    public WebMenuBar setFontStyle ( final boolean bold, final boolean italic )
    {
        return FontMethodsImpl.setFontStyle ( this, bold, italic );
    }

    @Override
    public WebMenuBar setFontStyle ( final int style )
    {
        return FontMethodsImpl.setFontStyle ( this, style );
    }

    @Override
    public WebMenuBar setFontSize ( final int fontSize )
    {
        return FontMethodsImpl.setFontSize ( this, fontSize );
    }

    @Override
    public WebMenuBar changeFontSize ( final int change )
    {
    ...
    @Override
    public WebMenuBar setFontSizeAndStyle ( final int fontSize, final boolean bold, final boolean italic )
    {
        return FontMethodsImpl.setFontSizeAndStyle ( this, fontSize, bold, italic );
    }

    @Override
    public WebMenuBar setFontSizeAndStyle ( final int fontSize, final int style )
    {
        return FontMethodsImpl.setFontSizeAndStyle ( this, fontSize, style );
    }

    @Override
    public WebMenuBar setFontName ( final String fontName )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setPreferredWidth ( final int preferredWidth )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setPreferredHeight ( final int preferredHeight )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setPreferredSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMaximumWidth ( final int maximumWidth )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMaximumHeight ( final int maximumHeight )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMinimumWidth ( final int minimumWidth )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMinimumHeight ( final int minimumHeight )
    {
    ...
    @NotNull
    @Override
    public WebMenuBar setMinimumSize ( final int width, final int height )
    {
