...
public class WebBasicTabbedPaneUI extends TabbedPaneUI implements SwingConstants
{
    ...
    protected void installKeyboardActions ()
    {
        ...
        LazyActionMap.installLazyActionMap ( tabPane, WebBasicTabbedPaneUI.class, "TabbedPane.actionMap" );
        updateMnemonics ();
    }
                                 ...
                                 final Rectangle tabRect, final Rectangle iconRect, final Rectangle textRect, final boolean isSelected )
    {
        ...
        SwingUtilities
                .layoutCompoundLabel ( tabPane, metrics, title, icon, SwingUtilities.CENTER, SwingUtilities.CENTER, SwingUtilities.CENTER,
    ...
    protected void paintContentBorderBottomEdge ( final Graphics g, final int tabPlacement, final int selectedIndex, final int x,
    ...
    protected void paintContentBorderRightEdge ( final Graphics g, final int tabPlacement, final int selectedIndex, final int x,
                                                 final int y, final int w, final int h )
    {
        final Rectangle selRect = selectedIndex < 0 ? null : getTabBounds ( selectedIndex, calcRect );
    ...
    protected static class Actions extends UIAction
    {
        ...
        public void actionPerformed ( final ActionEvent e )
        {
            ...
            final WebBasicTabbedPaneUI ui =
                    WebBasicTabbedPaneUI.class.isInstance ( pane.getUI () ) ? ( WebBasicTabbedPaneUI ) pane.getUI () : null;
            ...
            if ( numChildren > 0 )
            {
                ...
                for ( int i = 0; i < numChildren; i++ )
                {
                    ...
                    if ( child == tabContainer )
                    {
                        ...
                        final int tabContainerWidth = totalTabWidth == 0 ? bounds.width : totalTabWidth + insets.left + insets.right +
                                contentInsets.left + contentInsets.right;
                        final int tabContainerHeight = totalTabHeight == 0 ? bounds.height : totalTabHeight + insets.top + insets.bottom +
                                contentInsets.top + contentInsets.bottom;
            ...
            if ( map != null )
            {
                ...
                if ( action != null && action.isEnabled () )
                {
                    action.actionPerformed (
                            new ActionEvent ( tabPane, ActionEvent.ACTION_PERFORMED, null, e.getWhen (), e.getModifiers () ) );
                }
            }
        }
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource
    {
        ...
        public void paintComponent ( final Graphics g )
        {
            ...
            WebBasicTabbedPaneUI.this.paintTabArea ( g, tabPane.getTabPlacement (), tabPane.getSelectedIndex () );
            ...
            implements ChangeListener, ContainerListener, FocusListener, MouseListener, MouseMotionListener, PropertyChangeListener
    {
        ...
        private void updateHtmlViews ( final int index )
        {
