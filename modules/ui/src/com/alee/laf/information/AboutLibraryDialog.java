...
public class AboutLibraryDialog extends WebFrame
{
    ...
    private AboutLibraryDialog ()
    {
        ...
        documentPane.openDocument ( new DocumentData (
                "general",
                "weblaf.about.dialog.general.title",
                createGeneralTab ()
        ), true );

        documentPane.openDocument ( new DocumentData (
                "libraries",
                "weblaf.about.dialog.libraries.title",
                createLibrariesTab ()
        ), false );

        documentPane.openDocument ( new DocumentData (
                "properties",
                "weblaf.about.dialog.properties.title",
                createPropertiesTab ()
        ), false );
    ...
    private Component createLibrariesTab ()
    {
        ...
        try
        {
            ...
            // Parsing available libraries information
            ...
            for ( final Map.Entry<String, String> library : librariesData.entrySet () )
            {
                for ( final JarEntry child : licensesFolder.getChildren () )
                {
                    if ( Objects.equals ( library.getKey (), child.getName () ) )
                    {
                        ...
                        final WebLabel licenseLabel = new WebLabel ( "weblaf.about.dialog.libraries.license" );
                        final WebLink licenseLink = new WebLink ( new AbstractLinkAction ( child.getName () )
                        {
                            ...
                            public void linkExecuted ( @NotNull final ActionEvent event )
                            {
                                ...
                                final WebDialog licenseDialog = new WebDialog ( AboutLibraryDialog.this, child.getName () );
                        ...
                        // Library site URL
                        final WebLabel siteLabel = new WebLabel ( "weblaf.about.dialog.libraries.site" );
        ...
        {
            // Error label
            tab = new WebLabel ( "weblaf.about.dialog.libraries.error", WebLabel.CENTER );
        }
        return tab;
    }
    ...
    public static void main ( final String[] args )
    {
        CoreSwingUtils.invokeLater ( new Runnable ()
        {
            ...
            public void run ()
            {
                ...
                final AboutLibraryDialog dialog = new AboutLibraryDialog ();
