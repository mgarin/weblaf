...
/**
 * Tree expansion behavior that automatically expands node futher if it has only one child.
...
public class AutoExpandSingleChildBehavior implements TreeExpansionListener, Behavior
{
    @Override
     ...
     */
    public static AutoExpandSingleChildBehavior install ( final JTree tree )
    {
        // Uninstall old behavior first
        uninstall ( tree );

        // Add new adapter
        final AutoExpandSingleChildBehavior adapter = new AutoExpandSingleChildBehavior ();
    ...
    public static void uninstall ( final JTree tree )
    {
        ...
        {
            if ( listener instanceof AutoExpandSingleChildBehavior )
            {
