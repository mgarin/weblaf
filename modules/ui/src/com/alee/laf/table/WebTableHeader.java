 ...
 */
public class WebTableHeader extends JTableHeader implements Styleable, EventMethods, LanguageMethods, LanguageEventMethods,
        SettingsMethods, FontMethods<WebTableHeader>, SizeMethods<WebTableHeader>
{
    /**
    ...
    @Override
    public WebTableHeader setPlainFont ()
    {
        return FontMethodsImpl.setPlainFont ( this );
    }

    @Override
    public WebTableHeader setPlainFont ( final boolean apply )
    {
    ...
    @Override
    public WebTableHeader setBoldFont ()
    {
        return FontMethodsImpl.setBoldFont ( this );
    }

    @Override
    public WebTableHeader setBoldFont ( final boolean apply )
    {
    ...
    @Override
    public WebTableHeader setItalicFont ()
    {
        return FontMethodsImpl.setItalicFont ( this );
    }

    @Override
    public WebTableHeader setItalicFont ( final boolean apply )
    {
    ...
    @Override
    public WebTableHeader setFontStyle ( final boolean bold, final boolean italic )
    {
        return FontMethodsImpl.setFontStyle ( this, bold, italic );
    }

    @Override
    public WebTableHeader setFontStyle ( final int style )
    {
        return FontMethodsImpl.setFontStyle ( this, style );
    }

    @Override
    public WebTableHeader setFontSize ( final int fontSize )
    {
        return FontMethodsImpl.setFontSize ( this, fontSize );
    }

    @Override
    public WebTableHeader changeFontSize ( final int change )
    {
    ...
    @Override
    public WebTableHeader setFontSizeAndStyle ( final int fontSize, final boolean bold, final boolean italic )
    {
        return FontMethodsImpl.setFontSizeAndStyle ( this, fontSize, bold, italic );
    }

    @Override
    public WebTableHeader setFontSizeAndStyle ( final int fontSize, final int style )
    {
        return FontMethodsImpl.setFontSizeAndStyle ( this, fontSize, style );
    }

    @Override
    public WebTableHeader setFontName ( final String fontName )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setPreferredWidth ( final int preferredWidth )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setPreferredHeight ( final int preferredHeight )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setPreferredSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMaximumWidth ( final int maximumWidth )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMaximumHeight ( final int maximumHeight )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMinimumWidth ( final int minimumWidth )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMinimumHeight ( final int minimumHeight )
    {
    ...
    @NotNull
    @Override
    public WebTableHeader setMinimumSize ( final int width, final int height )
    {
