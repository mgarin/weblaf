 ...
 */
public abstract class AbstractTextFieldDescriptor<C extends JTextField, U extends WTextFieldUI>
        extends AbstractTextComponentDescriptor<C, U>
{
     ...
     */
    public AbstractTextFieldDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
