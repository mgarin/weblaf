 ...
 */
public abstract class AbstractEditorPaneDescriptor<C extends JEditorPane, U extends WEditorPaneUI>
        extends AbstractTextComponentDescriptor<C, U>
{
     ...
     */
    public AbstractEditorPaneDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
