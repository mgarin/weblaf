 ...
 */
public abstract class AbstractToolBarDescriptor<C extends JToolBar, U extends WebToolBarUI> extends AbstractComponentDescriptor<C, U>
{
    /**
     ...
     */
    public AbstractToolBarDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
