 ...
 */
public class WebToolBarSeparator extends JToolBar.Separator implements Styleable, EventMethods, SettingsMethods,
        FontMethods<WebToolBarSeparator>, SizeMethods<WebToolBarSeparator>
{
    /**
    ...
    @NotNull
    @Override
    public WebToolBarSeparator setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebToolBarSeparator setMinimumSize ( final int width, final int height )
    {
