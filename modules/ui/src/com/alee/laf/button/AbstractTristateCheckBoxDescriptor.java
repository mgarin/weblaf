 ...
 */
public abstract class AbstractTristateCheckBoxDescriptor<C extends WebTristateCheckBox, U extends WTristateCheckBoxUI>
        extends AbstractComponentDescriptor<C, U>
{
     ...
     */
    public AbstractTristateCheckBoxDescriptor ( final String id, final Class<C> componentClass, final String uiClassId,
