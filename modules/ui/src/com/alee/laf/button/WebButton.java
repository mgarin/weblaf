 ...
 * @see JButton
 */
public class WebButton extends JButton implements Styleable, EventMethods, ToolTipMethods, LanguageMethods, LanguageEventMethods,
        SettingsMethods, FontMethods<WebButton>, SizeMethods<WebButton>
{
    /**
    ...
    @NotNull
    @Override
    public WebButton setMaximumSize ( final int width, final int height )
    {
    ...
    @NotNull
    @Override
    public WebButton setMinimumSize ( final int width, final int height )
    {
