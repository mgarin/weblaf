 ...
 */
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> implements IterableMap<K, V>
{
    /**
     ...
     */
    protected AbstractHashMap ( final int initialCapacity )
    {
     ...
     */
    protected AbstractHashMap ( int initialCapacity, final float loadFactor )
    {
        super ();
     ...
     */
    protected AbstractHashMap ( final int initialCapacity, final float loadFactor, final int threshold )
    {
        super ();
        this.loadFactor = loadFactor;
        this.data = new HashEntry[ initialCapacity ];
    ...
    public boolean containsValue ( final Object value )
    {
        if ( value == null )
        {
            for ( final HashEntry aData : data )
            {
                HashEntry entry = aData;
                while ( entry != null )
                {
     ...
     * @param <V> the type of mapped values
     */
    protected static class HashMapIterator<K, V> extends HashIterator<K, V, K> implements MapIterator<K, V>
    {
        /**
         * Constructs new {@link HashMapIterator}.
         *
         * @param parent {@link AbstractHashMap}
         */
        protected HashMapIterator ( final AbstractHashMap parent )
        {
            super ( parent );
        }
    ...
    protected static class EntrySet<K, V> extends AbstractSet<Map.Entry<K, V>>
    {
         ...
         * The parent map
         */
        protected final AbstractHashMap<K, V> parent;

        /**
         * Constructs new {@link EntrySet}.
         *
         * @param parent {@link AbstractHashMap}
         */
        protected EntrySet ( final AbstractHashMap parent )
        {
            super ();
            this.parent = parent;
        }
     ...
     * @param <V> the type of mapped values
     */
    protected static class EntrySetIterator<K, V> extends HashIterator<K, V, HashEntry<K, V>>
    {
        /**
    ...
    protected static class KeySet<K, V> extends AbstractSet<K>
    {
         ...
         * @param parent {@link AbstractHashMap}
         */
        protected KeySet ( final AbstractHashMap<K, V> parent )
        {
            super ();
            this.parent = parent;
        }
     ...
     * @param <V> the type of mapped values
     */
    protected static class KeySetIterator<K, V> extends HashIterator<K, V, K>
    {
        /**
     ...
     * @param <V> the type of mapped values
     */
    protected static class Values<K, V> extends AbstractCollection
    {
        /**
         * The parent map
         */
     ...
     * @param <V> the type of mapped values
     */
    protected static class ValuesIterator<K, V> extends HashIterator<K, V, V>
    {
        /**
         ...
         * @param parent {@link AbstractHashMap}
         */
        protected ValuesIterator ( final AbstractHashMap<K, V> parent )
        {
            super ( parent );
        }
    ...
    protected static class HashEntry<K, V> implements Map.Entry<K, V>, KeyValue<K, V>
    {
         ...
         * @param value    the value to store
         */
        protected HashEntry ( final HashEntry<K, V> next, final int hashCode, final K key, final V value )
        {
            super ();
            this.next = next;
     ...
     * @param <V> the type of mapped values
     */
    protected static abstract class HashIterator<K, V, T> implements Iterator<T>
    {
        /**
         * The parent map
         */
         ...
         * @param parent {@link AbstractHashMap}
         */
        protected HashIterator ( final AbstractHashMap<K, V> parent )
        {
            super ();
            this.parent = parent;
